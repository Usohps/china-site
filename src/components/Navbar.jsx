  ...
  return (
    ...
    <div className="relative bg-white">
      ...
      <FiAlignJustify className="lg:hidden" size={24} />
       ...
       <input placeholder="search" className="  lg:w-[500px] p-2" type="text" />
     </div>
         <div>
          <RxAvatar size={32}/>
         </div>
     ...
     <input placeholder="search" className=" lg:hidden w-full border p-2" type="text" />
     </div>
     <div className=" border-t-[1px] hidden lg:flex items-center justify-between gap-5 text-left">
       ...
       {/* Dropdown Menu */}
       {categoryOpen && (
         <ul className=" absolute left-[0%] top-[100%] ml-2 p-2 w-1/2 z-40 min-h-[400px] bg-white border border-gray-200 shadow-xl rounded-lg">
      ...
      <div className=" flex justify-between items-center bg-white z-50 px-6 p-4 sticky top-0 ">
       ...
       <input placeholder="search" className="  lg:w-[500px] p-2" type="text" />
        ...
        <input placeholder="search" className=" lg:hidden w-full rounded-lg border p-2" type="text" />
        </div>
